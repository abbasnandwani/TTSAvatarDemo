...
using static DemoKBApi.Controllers.ChatController;
...
namespace DemoKBApi.Controllers
{
    ...
    public class ChatController : ControllerBase
    {
        ...
        public async Task<List<Ticket>> GetTickets()
        {
            ...
            return TicketRepo.Instance.Tickets;
        }
        ...
        [HttpPost]
        public async Task PostStream1(UserInput input)
        {
        ...
        public async Task PostStream(UserInput input)
        {
            ...
            SKOrchestrator sKOrchestrator = new SKOrchestrator(_chatHistoryService, sessionId, _kernel);

            //var chatUpdate = await sKOrchestrator.Query(input.Query);

            //ChatResponse chatResponse = new ChatResponse();

            //if (chatUpdate != null)
            //{
            //    chatResponse.Role = chatUpdate.Role.ToString();
            //    chatResponse.Content = chatUpdate.Content;
            ...
            var result = await sKOrchestrator.QueryStream(input.Query, Response);
